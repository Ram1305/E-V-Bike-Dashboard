...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.shader = ui.Gradient.linear(
        ...
        [const Color( 0xFF06ECEC).withOpacity(1), const Color( 0xFF06ECEC)],
        [0, 1]);
    ...
    paint1Fill.shader = ui.Gradient.radial(
      ...
      [
        const Color( 0xFF06ECEC).withOpacity(0.85),
        const Color( 0xFF06ECEC).withOpacity(0),
      ],
      [0, 1],
    );
    ...
    paint2Fill.shader = ui.Gradient.linear(
      ...
      const Color( 0xFF06ECEC).withOpacity(1),
      const Color( 0xFF06ECEC).withOpacity(0)
    ], [
      0,
      1
...
class AverageMillagePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.shader = ui.Gradient.linear(
      ...
      const Color( 0xFF06ECEC).withOpacity(1),
      const Color( 0xFF06ECEC).withOpacity(0.79)
    ], [
      0,
      1
    ]);
